package com.yourenkeji.shenghuidai.wxapi;
...
//				});
//			}
//		}, ShareActivity.this, "胜辉贷：安全、短期、稳健收益", "来胜辉贷，轻松享受短期、安全、高收益理财产品，现在体验还可以获赠50元新手红包。", BeanUrl.YAOQINGLIANJIE_STRING + invite_code, R.drawable.logo);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		ShareUtils.getShareOnActivityResult(ShareActivity.this, requestCode, resultCode, data);
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.fengxiang:
				ShareUtils.getOpen();// 预留（可以放心删除，上一个页面已经有分享）
				break;
			default:
				break;
		}
