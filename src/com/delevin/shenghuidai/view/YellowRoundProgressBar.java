 ...
 * 
 */
public class YellowRoundProgressBar extends View {
	/**
	 * 画笔对象的引用
	 */
	private Paint paint;
	...
	public YellowRoundProgressBar(Context context) {
		this(context, null);
	}

	public YellowRoundProgressBar(Context context, AttributeSet attrs) {
	...
	public YellowRoundProgressBar(Context context, AttributeSet attrs,
		...
		roundColor = mTypedArray.getColor(
				R.styleable.RoundProgressBar_roundColor, context.getResources()
						.getColor(R.color.e6e6e6));
		roundProgressColor = mTypedArray.getColor(
				R.styleable.RoundProgressBar_roundProgressColor, context
						.getResources().getColor(R.color.boluo_Yellow));
		textColor = mTypedArray.getColor(
				R.styleable.RoundProgressBar_textColors, context.getResources()
