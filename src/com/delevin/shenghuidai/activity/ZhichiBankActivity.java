...
import com.delevin.shenghuidai.adapter.ZhichiBankAdapter;
...
public class ZhichiBankActivity extends BaseActivity {
	...
	protected void findViews() {
		...
		adapter = new ZhichiBankAdapter(getApplicationContext(), datas, R.layout.item_zhichi_bank);
	...
	private void getDatas(final boolean isenter, final boolean isrefresh) {
		...
		Myapplication.okhttpManger.sendComplexForm(this, false, strUrl, null, new Funck4() {
				...
				try {
					...
					if (jsonObject.getString("code").equals("10000")) {
						...
						if (array.length() == 0) {
							...
							list = JSON.parseArray(array.toString(), BeanZhichiBank.class);
							datas.addAll(list);
