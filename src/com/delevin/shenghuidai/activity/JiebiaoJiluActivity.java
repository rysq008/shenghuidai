...
import com.delevin.shenghuidai.adapter.JiebiaoJiluAdapter;
 ...
 */
public class JiebiaoJiluActivity extends BaseActivity implements OnItemClickListener {
	...
	private JiebiaoJiluAdapter adapter;
	...
	protected void findViews() {
		...
		adapter = new JiebiaoJiluAdapter(getApplicationContext(), datas, R.layout.touzi_mingxi_item);
	...
	private void getDatas(final boolean isenter, final boolean isrefresh) {
		...
		Myapplication.okhttpManger.sendComplexForm(this, false, QntUtils.getURL(BeanUrl.TOUZI_MINGXI_STRING, BoluoUtils.getShareOneData(getApplicationContext(), "phone")) + index + "?index=2", null, new Funck4() {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		Intent intent = new Intent(JiebiaoJiluActivity.this, MyTouziCoarseDetailsActivity.class);// BidDetalsActivity
