...
public class MobileSecurePayer {
	 ...
	 *            目标activity
	 * @param pay_product
	 *            0:快捷支付 1:认证支付 2:预授权支付 3:游易付 4:随心付
	 * @param signCard
	 *            单独签约标识
	 * @param isTest
	 *            测试环境
	 * @return
	 */
	public boolean pay(String strOrderInfo, final Handler callback,final int myWhat, final Activity activity, String pay_product,
			boolean signCard, boolean isTest) {
		if (mbPaying)
			return false;
		mbPaying = true;
